...
const OneCard = ({ itm }) => {
    ...
    return <div className="flex flex-col w-full bg-blue-200 rounded-xl p-2">
        ...
        <div className="flex flex-row" >
            <img className="w-[50%]" src={image_base_url + itm.coverImage} />

            <div className="flex flex-col w-[50%] m-2 ">
                <div className="flex flex-col h-[50%] relative"><h5 className="absolute">OCR Text</h5> 
                ...
                <div className="flex flex-col h-[50%] relative top-2"><h5 className="absolute">BASE64</h5> <p className="absolute top-6 overflow-scroll h-[80%] break-anywhere" style={{lineBreak:"anywhere"}}>{itm.encoded_image}</p></div>
            </div>

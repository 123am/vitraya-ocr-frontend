    ...
    return <div className="flex flex-row h-[94%] m-4 w-full bg-blue-200 rounded-xl p-2">
        ...
        <div className="flex flex-row w-full" >
            ...
            <div className="flex flex-col h-[100%] w-[100%] m-2 ">
                <div className="flex flex-col h-[33%] relative">
                    <h5 className="absolute">OCR Text Same As Image</h5>
                ...
                <div className="flex flex-col h-[33%] relative top-2">
                    <h5 className="absolute">OCR Formatted Text</h5>
                    <p className="bg-slate-200  mr-4 absolute top-6 overflow-scroll h-[80%] break-anywhere p-6 rounded-lg " style={{ lineBreak: "anywhere" }}>{itm.tee}</p>
                </div>
                <div className="flex flex-col h-[33%] relative top-2">
                    <h5 className="absolute">BASE64</h5>
                    <p className="bg-slate-200  mr-4 absolute top-6 overflow-scroll h-[80%] break-anywhere p-6 rounded-lg " style={{ lineBreak: "anywhere" }}>{itm.encoded_image}</p>
                </div>
            </div>
